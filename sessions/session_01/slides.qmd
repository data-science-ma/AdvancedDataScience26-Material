...
*(not email, not Moodle — so everyone benefits from the answer; make sure to enable notifications as explained [here](https://github.com/data-science-ma/AdvancedDataScience26-Material?tab=readme-ov-file#activate-email-notifications))*
...
- **Next session:** open your existing Codespace at [github.com/codespaces](https://github.com/codespaces) — do not create a new one
