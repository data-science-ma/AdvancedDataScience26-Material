...
## The one thing residuals cannot tell you

All five diagnostic panels show properties of the *residuals* — the part of $y$ the model did not explain.

But there is a sixth problem that residuals cannot reveal:

. . .

> **Omitted variable bias (OVB):** a confounding variable that affects both $y$ and an included $x$ is missing from the model.

. . .

The residuals look fine — the bias is absorbed into the coefficient. The regression fits the data well. It just does so *for the wrong reason*.
