...
::: {.incremental}
- How extensively did you use Git _during your actual work_?
. . .
  - Staging, committing, and pushing extremely useful
  - For advanced applications: have a look at branching
- Avoid hard coding results
  - Not: `The estimated intercept of 724.71 USD...`
  - Better: `The estimated intercept of` r  round(coef(model1)[1], 2) `USD...`
- Use AI - but in a smart way
  - Style issues $\rightarrow$ work outline-based
  - Always check correctness (e.g. caption title)
  - **Always document** the use of AI
:::
---
...
Tools that turn raw output into **presentation-ready tables:**
...
**Example:** Gender (reference = Female)
